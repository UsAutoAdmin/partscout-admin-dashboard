    ...
    <section className="rounded-2xl border border-gray-200 bg-white p-5 shadow-sm dark:border-gray-800 dark:bg-white/[0.03]">
      <div className="flex flex-wrap items-start justify-between gap-4">
        <div>
          ...
          <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">Live control and key operating metrics for each scraper machine.</p>
        </div>
          ...
          return (
            <div key={machine.key} className="rounded-2xl border border-gray-200 bg-gray-50 p-4 dark:border-gray-800 dark:bg-black/20">
              ...
              <div className="mt-4 grid grid-cols-2 gap-3">
                ...
                <div className="rounded-xl bg-white p-3 dark:bg-white/[0.03]"><div className="text-xs text-gray-500 dark:text-gray-400">Sold workers / browsers</div><div className="mt-1 text-sm font-semibold text-gray-900 dark:text-white">{sold ? `${sold.targetWorkers} / ${sold.targetBrowsers}` : '—'}</div></div>
                <div className="rounded-xl bg-white p-3 dark:bg-white/[0.03]"><div className="text-xs text-gray-500 dark:text-gray-400">Active workers / browsers</div><div className="mt-1 text-sm font-semibold text-gray-900 dark:text-white">{active ? `${active.targetWorkers} / ${active.targetBrowsers}` : '—'}</div></div>
